...
You can remove the Javascript by setting `'moinframe.moments.lightbox' => false` in your `config.php`. See the [configuration](../02-configuration.md) for more information.
