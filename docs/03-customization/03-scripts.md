...
You can remove the scripts by setting `'moinframe.moments.lightbox' => false` in your `config.php`. See the [configuration](../02-configuration.md) for more information.
