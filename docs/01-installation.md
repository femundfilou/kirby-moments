...
> [!TIP] **Custom page slug**
> You can customize the slug being used through the [configuration](./02-configuration.md). If you change the slug after initialization, be sure to delete the previously generated page.
